# Schrodinger Cat - Interpretação Detalhada
...
**Data de Execução**: 2025-12-24T13:06:51.098375
...
Gato vivo e morto simultaneamente
...
- **Shots**: 1024
- **Tempo de Transpilação**: 0.03s
- **Tempo de Execução Total**: 5.39s
...
1. **|00⟩**: 575 medições (56.15%)
2. **|11⟩**: 438 medições (42.77%)
3. **|01⟩**: 6 medições (0.59%)
4. **|10⟩**: 5 medições (0.49%)
...
**Schrodinger Cat em EQUILÍBRIO quântico**
