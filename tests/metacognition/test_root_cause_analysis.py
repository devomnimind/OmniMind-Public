...
class TestRootCauseEngine:
    ...
    def test_analyze_cascading_failure(self):
        ...
        engine.register_component("web-1", ComponentType.SERVICE, "Web Server", dependencies=["cache-1"])
    ...
    def test_complex_dependency_graph(self):
        ...
        engine.register_component("web-1", ComponentType.SERVICE, "Web", dependencies=["cache-1", "db-1"])
        engine.register_component("queue-1", ComponentType.QUEUE, "Queue", dependencies=["db-1"])
        engine.register_component("api-1", ComponentType.API, "API", dependencies=["web-1", "queue-1"])
