...
class TestEgoAgent:
    ...
    def test_select_defense_mechanism(self) -> None:
        ...
        assert defense_low in [DefenseMechanism.SUBLIMATION, DefenseMechanism.RATIONALIZATION]
        
        # Moderate conflict
        defense_mid = ego.select_defense_mechanism(conflict_severity=0.5)
        assert defense_mid in [DefenseMechanism.DISPLACEMENT, DefenseMechanism.PROJECTION]
