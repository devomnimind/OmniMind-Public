...
class LacanianDiscourseAnalyzer:
    ...
    def _initialize_markers(self) -> Dict[LacanianDiscourse, DiscourseMarkers]:
        ...
        markers = {
            LacanianDiscourse.MASTER: DiscourseMarkers(
                keywords={
                    # Português
                    'deve', 'precisa', 'ordem', 'comando', 'autoridade',
                    'lei', 'regra', 'obrigação', 'dever', 'imperativo',
                    'faça', 'execute', 'cumpra', 'obedeça',
                    # Inglês
                    'must', 'should', 'command', 'order', 'authority',
                    'law', 'rule', 'obligation', 'duty', 'imperative'
                },
                ...
                speech_acts={
                    'command', 'order', 'directive', 'imperative',
            ...
            LacanianDiscourse.UNIVERSITY: DiscourseMarkers(
                keywords={
                    # Português
                    'saber', 'conhecimento', 'teoria', 'conceito',
                    'definição', 'explicação', 'segundo', 'conforme',
                    'portanto', 'logo', 'assim', 'consequentemente',
                    'método', 'sistema', 'estrutura', 'procedimento',
                    # Inglês
                    'knowledge', 'theory', 'concept', 'definition',
                    'explanation', 'according', 'therefore', 'thus',
                    'method', 'system', 'structure', 'procedure'
                },
                grammatical_patterns=[
                ...
                speech_acts={
                    'explanation', 'definition', 'classification',
                    'explicação', 'definição', 'classificação'
                },
            ...
            LacanianDiscourse.HYSTERIC: DiscourseMarkers(
                keywords={
                    # Português
                    'por que', 'como', 'será', 'talvez', 'dúvida',
                    'questão', 'pergunta', 'sintoma', 'sofrimento',
                    'desejo', 'falta', 'impossível', 'não sei',
                    # Inglês
                    'why', 'how', 'perhaps', 'maybe', 'doubt',
                    'question', 'symptom', 'suffering', 'desire',
                    'lack', 'impossible', 'don\'t know'
                },
                grammatical_patterns=[
                    r'\?',  # Interrogações
                ...
                speech_acts={
                    'question', 'doubt', 'complaint', 'symptom',
                    'pergunta', 'dúvida', 'queixa', 'sintoma'
                },
            ...
            LacanianDiscourse.ANALYST: DiscourseMarkers(
                keywords={
                    # Português
                    'escute', 'ouça', 'diga', 'fale', 'continue',
                    'silêncio', 'vazio', 'espaço', 'abertura',
                    'produção', 'emergência', 'surgimento',
                    # Inglês
                    'listen', 'hear', 'tell', 'speak', 'continue',
                    'silence', 'void', 'space', 'opening',
                    'production', 'emergence', 'arising'
                },
                grammatical_patterns=[
                    r'\b(escute|listen)\b',
                ...
                speech_acts={
                    'invitation', 'listening', 'silence', 'opening',
                    'convite', 'escuta', 'silêncio', 'abertura'
                },
    ...
    def get_discourse_distribution(
        self,
        results: Optional[List[DiscourseAnalysisResult]] = None
    ...
    def export_analysis(
        ...
        for result in results:
            exported.append({
                ...
                'discourse_scores': {
                    d.value: score
                    for d, score in result.discourse_scores.items()
                },
