# Módulo Mecanismos de Atenção

## 📋 Descrição Geral

**Saliência, foco, filtragem atencional**
...
### Outputs
- Métricas específicas do módulo armazenadas em `data/attention/`
- Logs em formato estruturado para análise
- Contribuição para métricas globais do sistema

### Validação
- Testes unitários: `tests/attention/`
...
- ✅ Executar testes antes de commit: `pytest tests/attention/ -v`
...
# Dependências específicas do módulo listadas em requirements/attention.txt (se existir)
```
...
### Testes
- **Suite de Testes**: `tests/attention/`
