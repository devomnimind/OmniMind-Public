...
class ImageOptimizer:
    ...
    def __init__(self, default_quality: int = 85, strip_metadata: bool = True):
        """
    ...
    def optimize_jpeg(
        self, image_bytes: bytes, quality: Optional[int] = None, progressive: bool = True
    ) -> bytes:
        """
        Optimize JPEG image.
        ...
        try:
            ...
            img.save(output, format="JPEG", quality=quality, optimize=True, progressive=progressive)
    ...
    def optimize_png(self, image_bytes: bytes, compress_level: int = 9) -> bytes:
        """
        Optimize PNG image.
    ...
    def auto_optimize(
        self, image_bytes: bytes, target_format: Optional[str] = None, quality: Optional[int] = None
    ) -> Tuple[bytes, str]:
        """
    ...
    def get_image_info(self, image_bytes: bytes) -> dict:
        ...
        """
        if not PIL_AVAILABLE:
            return {"error": "PIL not available", "size_bytes": len(image_bytes)}
        ...
        try:
            ...
            return {"error": str(e), "size_bytes": len(image_bytes)}
